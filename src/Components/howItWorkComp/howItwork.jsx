    ...
    <div className="how_it_work_container">
      <div className="main_div_how_work">
        <div className="how_work_head_div">
          <h1 className="main_howWork_head">
            Vinted is your community for <u> pre-loved</u> fashion
          </h1>
          <p>
            37 million members, thousands of brands, and a whole lot of
            second-hand style. You’re in the right place. Here’s how it works.
          </p>
        </div>
          ...
          <div className="selling_simple_cards_div">
            <div className="selling_simple_cards">
              ...
              <p className="selling_card_para">
                Download the free Vinted app. Take photos of your item, describe
            ...
            <div className="selling_simple_cards">
              ...
              <p className="selling_card_para">
                Sold! Box your item, follow the shipping instructions, and make
                sure you send the item within 5 days.
              </p>
              <Link className="selling_card_link">learn more</Link>
            </div>
            <div className="selling_simple_cards">
          ...
          <div className="selling_simple_cards_div">
            ...
            <div className="selling_simple_cards">
              ...
              <p className="selling_card_para">
                ...
                we’ll let you know when it’s in the post. In a few days, it’ll
                be with you.
              </p>
              <Link className="selling_card_link">learn more</Link>
            </div>
          ...
          <div className="selling_simple_cards_div">
            <div className="selling_simple_cards_two">
              ...
              <div className="detail_cards">
                ...
                <p className="selling_card_para2">
                  As a buyer, you can choose to pay a buyer-protection fee. This
                  helps safeguard your money, adding an extra layer of
                  protection to your purchases and keeping your information
                  secure. The cost is 3–8% of the item price (excluding shipping
                  and taxes) plus $0.30–0.80.
                </p>
                <Link className="selling_card_link">learn more</Link>
              </div>
            </div>
            <div className="selling_simple_cards_two">
              ...
              <div className="detail_cards">
                ...
                <p className="selling_card_para2">
                  Your order is protected when you pay through Vinted. You’ll
                  get a refund if your item isn’t sent, was damaged in transit,
                  or is significantly not as described. Let us know within 2
                  days of delivery if something isn’t right. Unless otherwise
                  agreed, the buyer covers the return cost.
                </p>
                <Link className="selling_card_link">learn more</Link>
              </div>
            </div>
